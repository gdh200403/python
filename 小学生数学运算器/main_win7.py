...
def random_color_printer(text, delay=0.5, sleepseconds=2):
    # 定义颜色列表
    colors = [colorama.Fore.RED, colorama.Fore.GREEN, colorama.Fore.YELLOW, colorama.Fore.MAGENTA,
              colorama.Fore.CYAN]
    print()
    for char in text:
...
def prefix():
    print("\n郭钰涵:")
    random_color_printer('小朋友，你好！')
    random_color_printer('欢迎你来到数学的世界！')
    printer('\n我是数学王国的一个小算盘\n')
    print(colorama.Fore.GREEN + '加法' + colorama.Fore.RESET + '、' + colorama.Fore.RED + '减法' + colorama.Fore.RESET + '、' + colorama.Fore.GREEN + '乘法' + colorama.Fore.RESET + '、' + colorama.Fore.YELLOW + '除法' + colorama.Fore.RESET + '都是我的好朋友！')
    ...
    printer('今天,我特地来找你玩儿！')
    print('因为，我想和你' + colorama.Fore.GREEN + '交朋友！' + colorama.Fore.RESET)
    ...
    print(colorama.Fore.YELLOW + 'quit' + colorama.Fore.RESET)
    time.sleep(2)
    print('这是一个英文单词，意思是退出，输入它就可以' + colorama.Fore.RED + '结束' + colorama.Fore.RESET + '我们的游戏！我和我的四个小伙伴会一起算出你的游戏表现！')
    printer('好啦！游戏开始！')
...
while True:
    ...
    print(
        "\n(注意：" + colorama.Fore.GREEN + "乘号" + colorama.Fore.RESET + "用" + colorama.Fore.GREEN + '*' + colorama.Fore.RESET + "表示，" + colorama.Fore.YELLOW + "除号" + colorama.Fore.RESET + "用" + colorama.Fore.YELLOW + '/' + colorama.Fore.RESET + "表示。)")
    print("请选择模式(" + colorama.Fore.GREEN + '+' + colorama.Fore.RESET + '|' + colorama.Fore.RED + '-' + colorama.Fore.RESET + '|' + colorama.Fore.GREEN + '*' + colorama.Fore.RESET + '|' + colorama.Fore.YELLOW + '/' + colorama.Fore.RESET + '|' + colorama.Fore.MAGENTA + "pk" + colorama.Fore.RESET + " ):")
    mode = input()
    if mode not in ["+", "-", "*", "/", "pk"]:
    ...
    while True:
        ...
        # 校验答案，并统计做对的题数
            ...
            print(colorama.Fore.GREEN + '正确答案' + colorama.Fore.RESET + '应该是:' + colorama.Fore.YELLOW + str(
                answer) + colorama.Fore.RESET)
           # score -= 10

        # 统计总题数
        total_questions += 1

        if mode != "pk":  # 如果不是挑战模式，则显示得分
            print(f"当前得分：{score}\n") if score >= 0 else print(
                colorama.Fore.RED + f"当前得分：{score}\n" + colorama.Fore.RESET)
    ...
    # 根据正确率给出评价
    if accuracy == 1:
        print("太棒了，你真是个小算盘！"+colorama.Fore.RED +"★★★★★"+colorama.Fore.RESET)
    elif accuracy >= 0.9:
        print("非常好，你已经是一个小算盘了！"+colorama.Fore.RED +"★★★★"+colorama.Fore.RESET)
    elif accuracy >= 0.7:
        print("不错，你已经掌握了很多技巧！"+colorama.Fore.RED +"★★★"+colorama.Fore.RESET)
    elif accuracy >= 0.5:
        print("还需努力，多加练习，相信你会更厉害！"+colorama.Fore.RED +"❤❤❤"+colorama.Fore.RESET)
    else:
        print("加油，你一定能行！")
    print('')
