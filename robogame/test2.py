...
def calculate_physical_position(cx, cy):
    ...
    # 调整后的摄像头高度，考虑方块质心位置 (中心离地5厘米)
    adjusted_camera_height = camera_height - (cube_height / 2)
    ...
    # 计算垂直方向的投影距离 dy
    dy = adjusted_camera_height / np.tan(np.radians(tilt_angle - angle_y))
